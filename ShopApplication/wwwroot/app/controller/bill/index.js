        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.each($('#tbl-bill-details tr'), function (i, item) {
                    console.log($(item).find('select.ddlProductId option').first().data("price"));
    ...
    function getProductOptions(selectedId) {
        ...
        $.each(cachedObj.products, function (i, product) {
            ...
            if (selectedId === product.Id)
                products += '<option value="' + product.Id + '" selected="select" data-price="'+product.Price+'">' + product.Name + '</option>';
            else
                products += '<option value="' + product.Id + '" data-price="' + product.Price +'">' + product.Name + '</option>';
        });
        products += "</select>";
        return products;
    }
